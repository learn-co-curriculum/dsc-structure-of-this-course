...
So why do we provide solutions? Solutions can help you get unstuck once you've exhausted your problem solving resources. Sometimes it's not worth your time or energy to keep trying to solve a problem, especially if the problem ends up being something minor like a typo. In general, if you're not making any progress after 10-20 minutes then you should reach out to peers for help. If that doesn't get you unstuck, _then_ look at a solution. Read just enough of the solution to get unstuck, then continue on your own.
